...
@adapter.received(protocol['messages']['doRefundForCancelledOrder'])
def receiveRefundForCancelledOrder(message, enactment):
    logger.info("Buyer: refund received for the cancelled order: " + json.dumps(message))
